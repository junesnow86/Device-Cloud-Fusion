...
model.load_state_dict(
    torch.load("./checkpoints/pretrained/device_shufflenet_cifar10_0.1_distilled.pth")
)
...
with open("checkpoints/data/remaining_subset1_cifar10_0.3.pkl", "rb") as f:
...
train(
    ...
    batch_size=128,
    lr=0.01,
    checkpoint_save_path="./checkpoints/pretrained/device_shufflenet_cifar10_0.3_finetuned.pth",
)
