...
device_model2 = ImageClassificationModel(
    squeezenet1_0(weights=None, num_classes=backbone_out_features),
    backbone_out_features,
    num_classes=10,
)
...
distill(
    ...
    lr=0.001,
    temperature=20,
    # checkpoint_save_path="./checkpoints/cloud_resnet18_cifar10_0.1_distilled.pth",
)
