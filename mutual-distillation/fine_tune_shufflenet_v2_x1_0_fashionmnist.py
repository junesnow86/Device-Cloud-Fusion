...
backbone = shufflenet_v2_x1_0(weights=None, num_classes=256)
model = ImageClassificationModel(backbone, 256, num_classes=10)
model.load_state_dict(torch.load("./checkpoints/custom_shufflenet_v2_x1_0_cifar10.pth"))
...
train(
    ...
    batch_size=128,
    lr=0.1,
    checkpoint_save_path="./checkpoints/custom_shufflenet_v2_x1_0_fashionmnist_fine_tune.pth",
)
