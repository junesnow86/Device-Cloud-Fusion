...
model.load_state_dict(
    torch.load("./checkpoints/device_mobilenet_cifar10_0.4_distilled.pth")
)
...
with open("data/remaining_subset0_cifar10_0.2.pkl", "rb") as f:
...
train(
    ...
    batch_size=128,
    lr=0.001,
    checkpoint_save_path="./checkpoints/device_mobilenet_cifar10_0.2_finetuned.pth",
)
