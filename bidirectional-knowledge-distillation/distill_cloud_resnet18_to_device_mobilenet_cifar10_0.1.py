...
device_backbone = mobilenet_v3_small(weights=None, num_classes=backbone_out_features)
...
distill(
    ...
    batch_size=128,
    lr=0.01,
    checkpoint_save_path="./checkpoints/device_mobilenet_cifar10_0.1_distilled.pth",
)
