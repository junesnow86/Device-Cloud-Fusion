...
# cloud_sample_per_class = (class_counts * 0.1).int()
...
# with open("checkpoints/data/cloud_subset_cifar10_0.1.pkl", "wb") as f:
#     pickle.dump(cloud_subset, f)

# with open("checkpoints/data/remaining_subset_cifar10_0.9.pkl", "wb") as f:
...
with open("checkpoints/data/remaining_subset_cifar10_0.9.pkl", "rb") as f:
    remaining_subset = pickle.load(f)
...
with open("checkpoints/data/remaining_subset0_cifar10_0.3.pkl", "wb") as f:
    pickle.dump(subset0, f)

with open("checkpoints/data/remaining_subset1_cifar10_0.3.pkl", "wb") as f:
    pickle.dump(subset1, f)

with open("checkpoints/data/remaining_subset2_cifar10_0.3.pkl", "wb") as f:
