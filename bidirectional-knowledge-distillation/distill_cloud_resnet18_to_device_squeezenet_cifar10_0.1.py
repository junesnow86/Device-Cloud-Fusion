...
device_backbone = squeezenet1_0(weights=None, num_classes=backbone_out_features)
...
distill(
    ...
    batch_size=128,
    lr=0.01,
    checkpoint_save_path="./checkpoints/device_squeezenet_cifar10_0.1_distilled.pth",
)
