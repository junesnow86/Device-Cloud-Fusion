...
cloud_model.load_state_dict(
    torch.load("checkpoints/cloud_resnet18_cifar10_0.1_pretrained.pth")
)

device_backbone = shufflenet_v2_x1_0(weights=None, num_classes=backbone_out_features)
...
print(f"Teacher accuracy: {test_accuracy(cloud_model, test_data):.4f}")
...
distill(
    ...
    batch_size=128,
    lr=0.01,
    checkpoint_save_path="./checkpoints/device_shufflenet_cifar10_0.1_distilled.pth",
)
