...
model.load_state_dict(
    torch.load("./checkpoints/pretrained/device_squeezenet_cifar10_0.1_distilled.pth")
)
...
train(
    ...
    batch_size=128,
    lr=0.01,
    checkpoint_save_path="./checkpoints/pretrained/device_squeezenet_cifar10_0.3_finetuned.pth",
)
